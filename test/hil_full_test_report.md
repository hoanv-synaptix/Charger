...
- **Thời gian thực thi**: 2026-09-20 15:12:29
...
| 4 | Charging Logic | CL-04 | Nhiet do Pin Inhibit & Tu phuc hoi | **✅ PASS** | Inhibit target: 35.0A (flag=1), Phuc hoi: 8.5A |
| 5 | Charging Logic | CL-05 | Dap dong ve 0 truoc khi nha Contactor | **✅ PASS** | Dap dong ve 0 truoc khi ngat: True, State ve IDLE (0) |
| 6 | Charging Logic | CL-06 | Dong bo Allow Charge CAN sang BMS | **✅ PASS** | IDLE allow=False, RUN allow=True, STOP allow=False |
...
| 9 | Protection | IC-01 | Bat dau sac & On dinh dong ap | **✅ PASS** | MCU State: 2 (RUNNING), I=35.0A |
...
| 25 | CAN Robustness | CR-01 | Chong frame rac & sai dinh dang tren bus | **✅ PASS** | MCU hoat dong lien tuc khong treo ngat, Uptime tang: 262465 -> 263647 |
| 26 | CAN Robustness | CR-02 | Bus-Load Flood Stress Test | **✅ PASS** | MCU chiu tai xuat sac, CAN1 RX=2794, CAN2 RX=16637 |
