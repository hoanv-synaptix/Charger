...
static bool test_dwin_config_page_keys(void)
{
    ...
    /* Multi-word read response check (2 words: 0x1600=hours, 0x1601=minutes) */
    uint8_t multi_f[] = {
