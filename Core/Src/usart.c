...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PA10     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = MCU_PA9_USART1_TX_Pin|MCU_PA10_USART1_RX_Pin;
  ...
  */
    ...
    PB11     ------> USART3_RX
    */
    GPIO_InitStruct.Pin = MCU_PB10_USART3_TX_Pin|MCU_PB11_USART3_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END USART5_MspInit 0 */
    ...
    PB4     ------> USART5_RX
    */
    GPIO_InitStruct.Pin = MCU_PB3_USART5_TX_Pin|MCU_PB4_USART5_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, MCU_PA9_USART1_TX_Pin|MCU_PA10_USART1_RX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOB, MCU_PB10_USART3_TX_Pin|MCU_PB11_USART3_RX_Pin);
  ...
  /* USER CODE END USART5_MspDeInit 0 */
    ...
    PB4     ------> USART5_RX
    */
    HAL_GPIO_DeInit(GPIOB, MCU_PB3_USART5_TX_Pin|MCU_PB4_USART5_RX_Pin);
