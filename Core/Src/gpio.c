...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, MCU_PB0_SPI1_CS_Pin|MCU_PB9_SPI2_CS_Pin, GPIO_PIN_SET);
  ...
  HAL_GPIO_WritePin(GPIOB, MCU_PB14_RELAY_1_Pin|MCU_PB15_RELAY_2_Pin|MCU_PB5_LTE_PWR_EN_Pin|MCU_PB1_UART_RTS_Pin, GPIO_PIN_RESET);
